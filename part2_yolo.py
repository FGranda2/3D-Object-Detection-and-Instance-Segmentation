...
output_dir = 'data/test/output_images/' + sample_name + '.png'
output_box = 'data/test/output_box/' + sample_name
yolo_dir = 'yolo'
...
# Save bounding boxes
np.save(output_box, output_boxes)   # top left corner [x, y, w, h]
